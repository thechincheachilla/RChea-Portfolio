...
export function Profile() {
    ...
    return (
        <Box sx={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
            <Box sx={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                <Stack direction='column' gap={2} mr={5} maxWidth="40%">
                    <Stack direction='row' gap={1}>
                        ...
                        <Typography variant='h1' color='primary.dark'>Chea</Typography>
                    </Stack>
                    <Typography variant='body1' color='primary.dark'>
                        {profileText}
                    </Typography>
                </Stack>
                <Avatar sx={{ width: 250, height: 250}} src={require(".//Profile.jpg")} />
            </Box>
            ...
            <Typography variant="h3">"Your First Design Always Sucks" — James Wilson</Typography>
        </Box>
    )
}